...
var validateRegister = [
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (user) {
                            return [2 /*return*/, Promise.reject("email is used, please use other email")];
                        }
                        return [2 /*return*/, true];
                }
            });
    ...
    (0, express_validator_1.body)("password")
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var passwordIsValid;
            return __generator(this, function (_b) {
                passwordIsValid = password.match(define_1.REGEX_PASSWORD);
                if (!passwordIsValid) {
                    return [2 /*return*/, Promise.reject("Password must have at least 6 characters contains 1 number, 1 lower character")];
                }
                return [2 /*return*/, true];
            });
        });
